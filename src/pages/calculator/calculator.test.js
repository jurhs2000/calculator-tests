...
describe('Tests For Operations', () => {
  ...
  test('500000000 multiplied by 2 gives error because is greater than 999999999', () => {
    render(<Calculator />)
    const button5 = screen.getByText('5').parentElement
  ...
  test('7 divided by 3 gives 2.3333333', () => {
    render(<Calculator />)
    const button7 = screen.getByText('7').parentElement
    const button3 = screen.getByText('3').parentElement
    const buttonDivision = screen.getByText('/').parentElement
    const buttonEquals = screen.getByText('=').parentElement
    ...
    UserEvent.click(buttonEquals)
    const displayActual = screen.getByRole('displayActual')
    expect(displayActual.innerHTML).toBe('2.3333333')
  })
  test('1.2 plus 2.1 gives 3.3', () => {
    render(<Calculator />)
    const button1 = screen.getByText('1').parentElement
    const button2 = screen.getByText('2').parentElement
    const buttonDot = screen.getByText('.').parentElement
    const buttonPlus = screen.getByText('+').parentElement
    const buttonEquals = screen.getByText('=').parentElement
    UserEvent.click(button1)
    UserEvent.click(buttonDot)
    UserEvent.click(button2)
    UserEvent.click(buttonPlus)
    UserEvent.click(button2)
    UserEvent.click(buttonDot)
    ...
    UserEvent.click(buttonEquals)
    const displayActual = screen.getByRole('displayActual')
    expect(displayActual.innerHTML).toBe('3.3')
  })
  test('1.2 multiplied by 2.1 gives 2.52', () => {
    render(<Calculator />)
    const button1 = screen.getByText('1').parentElement
    const button2 = screen.getByText('2').parentElement
    const buttonDot = screen.getByText('.').parentElement
    ...
    UserEvent.click(buttonEquals)
    const displayActual = screen.getByRole('displayActual')
    expect(displayActual.innerHTML).toBe('2.52')
  })
